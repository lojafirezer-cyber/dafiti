...
export default function NacaoKids() {
  ...
  useEffect(() => {
    async function loadProducts() {
      setLoading(true);
      // Fetch products with tags CAMISETA INFANTIL or BODY INFANTIL
      const data = await fetchProducts(100, 'tag:"CAMISETA INFANTIL" OR tag:"BODY INFANTIL"');
      setProducts(data);
      setLoading(false);
    }
    loadProducts();
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 md:mb-8">
          <h1 className="text-xl md:text-3xl font-bold text-foreground mb-1 md:mb-2">Nação Kids</h1>
